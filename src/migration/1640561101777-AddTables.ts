...
export class AddTables1640561101777 implements MigrationInterface {
    name = 'AddTables1640561101777'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_profiles" ("id" SERIAL NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "birthday" TIMESTAMP WITH TIME ZONE NOT NULL, "job" character varying, "company" character varying, "study" character varying, "education" character varying, "bio" character varying, "team_status" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_1ec6662219f4605723f1e41b6cb" PRIMARY KEY ("id"))`);
