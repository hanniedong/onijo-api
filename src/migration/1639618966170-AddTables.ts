...
export class AddTables1639618966170 implements MigrationInterface {
    name = 'AddTables1639618966170'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_team_metadata" ("id" SERIAL NOT NULL, "year_joined" integer, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, "team_id" integer, CONSTRAINT "REL_cb67ea74cfdc594f6e82fadcf6" UNIQUE ("user_id"), CONSTRAINT "REL_4538c1e0617d60c4cfddae4510" UNIQUE ("team_id"), CONSTRAINT "PK_e238125fc90f08ad60472f01392" PRIMARY KEY ("id"))`);
