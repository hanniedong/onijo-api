...
ProfilesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.UserEntity, profile_entity_1.ProfileEntity]), files_module_1.FilesModule, users_module_1.UsersModule],
        controllers: [profiles_controller_1.ProfilesController],
        providers: [profiles_service_1.ProfilesService, profiles_resolver_1.ProfilesResolver],
